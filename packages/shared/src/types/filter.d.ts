 ...
 */
export type FilterOperator = "eq" | "neq" | "gt" | "gte" | "lt" | "lte" | "in" | "notIn" | "contains" | "startsWith" | "endsWith" | "exists" | "between";
/**
 ...
 */
export type FilterValue = string | number | boolean | null | string[] | number[] | DateRange;
/**
 ...
 */
export type FilterFieldType = "string" | "number" | "boolean" | "date" | "enum" | "array";
/**
