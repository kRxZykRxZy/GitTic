 ...
 */
export type ErrorCode = "VALIDATION_ERROR" | "AUTHENTICATION_ERROR" | "AUTHORIZATION_ERROR" | "NOT_FOUND" | "CONFLICT" | "RATE_LIMIT_EXCEEDED" | "INTERNAL_ERROR" | "SERVICE_UNAVAILABLE" | "BAD_REQUEST" | "PAYLOAD_TOO_LARGE" | "UNSUPPORTED_MEDIA_TYPE" | "UNPROCESSABLE_ENTITY" | "GATEWAY_TIMEOUT" | "METHOD_NOT_ALLOWED";
/**
 ...
 */
export type ValidationRule = "required" | "min_length" | "max_length" | "pattern" | "email" | "url" | "uuid" | "enum" | "min" | "max" | "unique" | "custom";
/**
