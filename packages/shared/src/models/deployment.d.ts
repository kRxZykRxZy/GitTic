 ...
 */
export type DeploymentStatus = "pending" | "queued" | "in_progress" | "success" | "failure" | "canceled" | "rolled_back" | "skipped";
/**
 * Strategy used to roll out the deployment.
 */
export type DeploymentStrategy = "rolling" | "blue_green" | "canary" | "recreate" | "manual";
/**
