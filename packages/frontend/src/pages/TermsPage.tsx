        ...
        <div style={pageStyle}>
            ...
            <section style={sectionStyle}>
                ...
                <p style={paragraphStyle}>
                    By accessing and using GitTic ("the Platform"), you agree to be bound by these Terms and Conditions
                    ("Terms"). If you do not agree to these Terms, please do not use the Platform.
                </p>
                <p style={paragraphStyle}>
                    These Terms constitute a legally binding agreement between you and GitTic Inc. ("we," "us," or "our").
                </p>
            </section>
            ...
            <section style={sectionStyle}>
                ...
                <p style={paragraphStyle}>
                    <strong>You must be at least 13 years old to use GitTic.</strong> By creating an account, you represent
            ...
            <section style={sectionStyle}>
                ...
                <p style={paragraphStyle}>
                    <strong>Your Content:</strong> You retain ownership of code and content you create. By uploading to GitTic,
            ...
            <section style={sectionStyle}>
                ...
                <p style={paragraphStyle}>
                    TO THE MAXIMUM EXTENT PERMITTED BY LAW, GITTIC SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL,
            ...
            <section style={sectionStyle}>
                ...
                <p style={paragraphStyle}>
                    You agree to indemnify and hold GitTic harmless from any claims, damages, losses, or expenses (including
            ...
            <section style={sectionStyle}>
                ...
                <ul style={listStyle}>
                    <li style={listItemStyle}>Email: legal@gittic.io</li>
                    <li style={listItemStyle}>Address: GitTic Inc., 123 Dev Street, Tech City, TC 12345</li>
                </ul>
            </section>
