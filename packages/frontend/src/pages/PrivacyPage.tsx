        ...
        <div style={pageStyle}>
            ...
            <section style={sectionStyle}>
                ...
                <p style={paragraphStyle}>
                    Welcome to GitTic ("we," "our," or "us"). We respect your privacy and are committed to protecting your personal data.
                    This privacy policy explains how we collect, use, disclose, and safeguard your information when you use our platform.
                </p>
                <p style={paragraphStyle}>
                    By using GitTic, you agree to the collection and use of information in accordance with this policy.
                </p>
            </section>
            ...
            <section style={sectionStyle}>
                ...
                <p style={paragraphStyle}>
                    <strong>GitTic is intended for users who are 13 years of age or older.</strong> We do not knowingly collect personal
            ...
            <section style={sectionStyle}>
                ...
                <p style={paragraphStyle}>
                    To exercise these rights, please contact us at privacy@gittic.io
                </p>
            </section>
            ...
            <section style={sectionStyle}>
                ...
                <ul style={listStyle}>
                    <li style={listItemStyle}>Email: privacy@gittic.io</li>
